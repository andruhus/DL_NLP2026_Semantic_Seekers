...
#SBATCH -t 00:30:00                  # estimated time # TODO: adapt to your needs
...
# Run the script:
python -u multitask_classifier.py --use_gpu --local_files_only --option finetune --task sst --hidden_dropout_prob 0.1 --epochs 30
