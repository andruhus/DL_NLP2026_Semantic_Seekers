...
#SBATCH --mail-user=simon.pummer@stud.uni-goettingen.de
...
# Run the script:
python -u multitask_classifier.py --task sst --option finetune --lr 2e-05 --batch_size 16 --warmup_ratio 0.2 --weight_decay 0 --label_smoothing 0.0 --classifier_dropout 0.3 --use_gpu --local_files_only > output.log 2> error.log