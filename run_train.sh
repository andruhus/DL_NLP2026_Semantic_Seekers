#!/bin/bash
#SBATCH --job-name=train-multitask_classifier_1
...
# Run the script:
python -u multitask_classifier.py --use_gpu --local_files_only --option finetune --epochs 1 --task etpc --hidden_dropout_prob 0.1
