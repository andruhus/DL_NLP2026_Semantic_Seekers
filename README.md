# DNLP SS26 Final Project — Multitask BERT
...
[![Status](https://img.shields.io/badge/Status-Final-purple.svg)](#)

</div>

- **Group name:** Semantic Seekers
- **Group code:** `TODO`
- **Group repository:** `TODO — GitLab/GitHub URL`
- **Tutor responsible:** `TODO`
- **Group team leader:** `TODO`
- **Group members:**
  - Mohd Uwaish — mohd.uwaish@stud.uni-goettingen.de — *Semantic Textual Similarity (STS)*
  - `TODO — name, email, task`
  - `TODO — name, email, task`
  - `TODO — name, email, task`
  - `TODO — name, email, task`

This repository contains our implementation of the multitask BERT project for the
*Deep Learning for Natural Language Processing* course at the University of Göttingen.

A minimal BERT ([Devlin et al., 2019](https://arxiv.org/abs/1810.04805)) implementation
(`bert.py`) and an AdamW optimizer ([Loshchilov & Hutter, 2019](https://arxiv.org/abs/1711.05101))
were written from scratch in Part 1, then extended in Part 2 with task-specific
improvements on top of a shared encoder.
...
> This section documents the **Semantic Textual Similarity (STS)** task.
> `TODO — teammates add SST / QQP / PTD / PTG methodology here.`
...
> `TODO — teammates fill in from your own runs.` Part 1 baselines shown for reference;
> Part 2 improvement rows are for the responsible member to complete.

| **Stanford Sentiment Treebank (SST)** | **Accuracy** |
| --- | --- |
| Baseline (Part 1) | 0.519 |
| Improvement 1 | `TODO` |

| **Quora Question Pairs (QQP)** | **Accuracy** |
| --- | --- |
| Baseline (Part 1) | 0.781 |
| Improvement 1 | 0.868 |
| Improvement *n* | `TODO` |

| **Paraphrase Type Detection (PTD)** | **Accuracy** | **MCC** |
| --- | --- | --- |
| Baseline (Part 1) | 0.952 | 0.427 |
| Improvement 1 | `TODO` | `TODO` |

| **Paraphrase Type Generation (PTG)** | **Penalized BLEU** |
| --- | --- |
| Baseline (Part 1) | 39.165 |
| Improvement 1 | `TODO` |
...
Artificial Intelligence (AI) aided the development of this project.
`TODO — generate the card at https://ai-cards.org/, commit the PDF, and link it here.`
