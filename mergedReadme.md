...
In order to reproduce the experimental result, the above described dependencies should be used. For reproducing the results, run following command:
...
The generation of the visualizations is dependent on matplotlib. Before executing the file logdiff.py, run the following command:
...
## Stanford Sentiment Treebank (SST) references
...
2. Si, Y., & Gao, X. (2023). Revisiting the Role of Label Smoothing in Enhanced Text Sentiment Classification. Semantic Scholar.
3. Xing, J., Xue, C., Luo, D., & Xing, R. (2024). Comparative Analysis of Pooling Mechanisms in LLMs: A Sentiment Analysis Perspective. arXiv:2411.14654.
4. ALLNLI Dataset: https://www.sbert.net/examples/sparse_encoder/training/nli/README.html