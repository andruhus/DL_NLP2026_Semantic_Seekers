...
The first improvement changes sentence pair representation used for the paraphrase detection.
...
This run used the explicit sentence-pair interaction representation with a linear classifier head.
